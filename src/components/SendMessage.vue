    ...
    <div class="view_wrap bg-[rgba(0,0,0,0.6)] w-[100%] h-[100%] fixed top-0 left-0 z-[999]">
        <div class="container translate-y-[-35%] absolute left-0 right-0 top-[35%] custom-bg">
            <form class="max-w-[500px] mx-auto rounded-[12px] p-[25px] bg-[#047eb4] relative">
                ...
                <label for="fullname-icon" class="block my-2 text-sm font-medium text-[#fff]">Email</label>
                ...
                <label for="fullname-icon" class="block my-2 text-sm font-medium text-[#fff]">Subject</label>
                <div class="relative">
                ...
                <label for="address-icon" class="block my-2 text-sm font-medium text-[#fff]">Message</label>
                <div class="relative">
                ...
                <button @click.prevent="messageStore.sendMessageHandler" class="d-block p-2 bg-[#dc3545] hover:bg-[#b92a38] text-center text-[#fff] mt-4 rounded-lg px-4" :class="{ 'opacity-[0.5]': messageStore.isSending, 'pointer-events-none': messageStore.isSending }">{{ messageStore.isSending ? 'Sending...' : 'Send' }}</button>
            </form>
        </div>
    </div>
</template>
