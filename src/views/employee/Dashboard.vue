...
watch(() => currentYear.value, (newYear, oldYear) => {
    if(newYear !== oldYear) activityStore.resetActivityData();
});
...
onMounted(() => {
    ...
    //     // Send a message to the parent document indicating that the button was clicked
    //     window.parent.postMessage('submitButtonClicked', 'https://www.legacyhealthus.com');
    // });
